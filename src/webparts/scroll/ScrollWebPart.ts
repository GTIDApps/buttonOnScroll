  ...
  public render(): void {
    ...
    this.domElement.innerHTML = `
      <button
        ...
        class="fixed bottom-5 right-5 p-3 rounded-full bg-transparent hover:bg-gray-200 focus:bg-gray-200 focus:outline-none focus:ring-0 shadow-md transition duration-150 ease-in-out"
        id="btn-back-to-top"
        title="Back to Top"
